...
function makerequest_27001(url_27003) {

function alertcontents_27013(e_27015) {

var F={procname:"makeRequest.alertContents",prev:framePtr,filename:"ex1.nim",line:0};
framePtr = F;
if ((httprequest_27004.readyState == 4)) {
if ((httprequest_27004.status == 200)) {
window.alert(httprequest_27004.responseText);
}
else {
...
var F={procname:"ex1.makeRequest",prev:framePtr,filename:"ex1.nim",line:0};
framePtr = F;
BeforeRet: do {
F.line = 5;
var httprequest_27004 = new XMLHttpRequest();
if ((httprequest_27004 === null)) {
...
F.line = 16;
httprequest_27004.onreadystatechange = alertcontents_27013;
httprequest_27004.open("GET", url_27003, true, null, null);
httprequest_27004.send();
} while (false); 
framePtr = F.prev;
}
function HEX3Aanonymous_27026(e_27028) {

var F={procname:"ex1.:anonymous",prev:framePtr,filename:"ex1.nim",line:0};
framePtr = F;
makerequest_27001("test.html");
framePtr = F.prev;
}
document.getElementById("ajaxButton").onclick = HEX3Aanonymous_27026;
